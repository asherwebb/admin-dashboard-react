...
<div className="container-fluid pad-top">
  <form>
    <div>
      <textarea ref="about_hotel" placeholder="About Hotel..." className="form-control">
      </textarea>
      <br />
    ...
    <div className="form-inline">
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="complimentary_wifi" type="checkbox" /> Complimentary Wifi
            </label>
          </div>
        </div>
        ...
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="complimentary_self_parking" type="checkbox" /> Complimentary self-parking
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="fitness_center" type="checkbox" /> Fitness Center
            </label>
          </div>
        </div>
        ...
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="outdoor_pool" type="checkbox" /> Outdoor Pool
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="valet_parking" type="checkbox" /> Valet Parking
            </label>
          </div>
        </div>
        ...
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="valet_parking_fee" type="checkbox" /> Valet Parking Fee
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="indoor_pool" type="checkbox" /> Indoor Pool
            </label>
          </div>
        </div>
        ...
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="hot_tub" type="checkbox" /> Hot Tub
            </label>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="sauna" type="checkbox" /> Sauna
            </label>
          </div>
        </div>
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="beach_access" type="checkbox" /> Beach Access
            </label>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="ski_access" type="checkbox" /> Ski Access
            </label>
          </div>
        </div>
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="spa_services" type="checkbox" /> Spa Services
            </label>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="restaurant_on_site" type="checkbox" /> Restaurant on Site
            </label>
          </div>
        </div>
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="bar_on_site" type="checkbox" /> Bar on Site
            </label>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="room_service" type="checkbox" /> Room Service
            </label>
          </div>
        </div>
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input ref="pets_allowed" type="checkbox" /> Pets Allowed
            </label>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input placeholder="Phone" ref="phone_checkbox" type="checkbox" /> Phone
            </label>
          </div>
        </div>
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input value="Restaurant serves Regional Cuisine" ref="restaurant_regional_cuisine" type="checkbox" /> Restaurant serves Regional Cuisine
            </label>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-xs-6">
          <div className="checkbox">
            <label>
              <input value="Drinks served at the Beach Club" ref="drinks_beach_club" type="checkbox" /> Drinks served at the Beach Club
            </label>
          </div>
        </div>
        <div className="col-xs-6">
	...
	</span> Make sure your images are saved at 640 pixels width and 520 pixels height at 72 pixels per inch in .jpg format
    </div>
    <br />
    <div className="alert alert-info" role="alert">
      <span className="glyphicon glyphicon-info-sign" aria-hidden="true">
	</span> You will see a preview of the image. Your images will be uploaded when you submit the entire form.
    </div>
    <fieldset>
      <label>
        Featured Image
